...
**بانک اطلاعاتی الوویپ**  : در صورتی که در مرحله قبل از گزینه دیتا بیس الوویپ استفاده کردید با استفاده از دیتابیس الوویپ  بخواهیم علاوه بر گزارشاتی که در حال حاضر هست  که میتوانید  گزارشات دیگری در این گزارش بتوانید بگیرید.
...
10. **DataBase**  : در این قسمت برای ایجاد دیاگرام DataBase از روش Drag & Drop استفاده کنید .
...
12. بعد از اینکه  با استفاده از روش Drag & Drop جدول های دیتابیس در این مرحله ایجاد کردید 

 
 ![](./Images/open-gozaresh13.jpg)
 
 13. طراحی گزارش  بعد از پیاده سازی **دیاگرام** و اجرای **Query** در نهایت با اسم مورد نیاز خود میتوانید این الگو را ذخیره کنید تا به مرحله **طراحی** **گزارش** برسید.
...
14. در این مرحله ما با استفاده از گزارش ساز پیشرفته گزارشی گرفتیم که به هر داخلی در DataBase با چه ID اختصاص داده شده است و در کدام سیستم تلفنی با این ID نمایش داده میشود . 